 ...
 */
package strongannotationtool.Design;

import strongannotationtool.Shapes.VisualShapes.DrawRectangle;
import com.jfoenix.controls.JFXButton;
import com.jfoenix.controls.JFXDialog;
import com.jfoenix.controls.JFXPopup;
import strongannotationtool.Shapes.Model.CustomGrid;
...
public class AnnotationPaneController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        scrollPane.sceneProperty().addListener((observable, oldValue, newValue) -> {

            if(!jfxDialog1.getContent().equals(root)) return;
